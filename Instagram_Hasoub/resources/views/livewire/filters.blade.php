<div class="max-w-4xl my-0 mx-auto">
    <div class="grid grid-cols-3 gap-4 mx-0 mt-0 mb-10">
        ...
        <div>
            ...
            <img src="/storage/uploads/10.jpeg" class="w-64 h-64 cursor-pointer" wire:model="filters" wire:click="applyFilter(10)">
        </div>
        
        <div>
            <p class="text-center">{{__('filter11')}}</p>
            <img src="/storage/uploads/11.jpeg" class="w-64 h-64 cursor-pointer" wire:model="filters" wire:click="applyFilter(11)">
        </div>
        
        <div>
            <p class="text-center">{{__('filter12')}}</p>
            <img src="/storage/uploads/12.jpeg" class="w-64 h-64 cursor-pointer" wire:model="filters" wire:click="applyFilter(12)">
        </div>
        
        <div>
            <p class="text-center">{{__('filter13')}}</p>
            <img src="/storage/uploads/13.jpeg" class="w-64 h-64 cursor-pointer" wire:model="filters" wire:click="applyFilter(13)">
        </div>
