<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <!-- URL -->
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="status" value="{{ __('Url') }}" />
            <x-jet-input id="status" type="text" class="mt-1 block w-full" wire:model.defer="state.url" autocomplete="url" />
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <select name="status" id="status" class="mt-1 block w-full form-input rounded-md shadow-sm" wire:model.defer="state.status">    
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <select name="language" id="language" class="mt-1 block w-full form-input rounded-md shadow-sm" wire:model.defer="state.language">    
